...
$fileCSS = ["publicacionesAdmin", "eventosAdmin","sidebar"];
$fileJS = ["publicacionesAdmin", "eventosAdmin", "noticiaAdmin","sidebar"];
...
<?php require_once("../view/sidebarcreaciones.php"); ?>
    ...
    <main>
        <div class="container">
            ...
            <div class="container text-center ocultar">
                <div class="row">
